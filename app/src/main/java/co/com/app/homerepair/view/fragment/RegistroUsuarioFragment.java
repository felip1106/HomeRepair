...
public class RegistroUsuarioFragment extends Fragment {
    ...
    @OnClick(R.id.image_customer)
    void showRegistroCliente(View view) {
        ((IRegistroView) getActivity()).showFragmentTipoUsuario(new RegistroClienteFragment());
    }

    @OnClick(R.id.image_worker)
    void showRegistroProveedor(View view) {
        ((IRegistroView) getActivity()).showFragmentTipoUsuario(new RegistroProveedorFragment());
    }
